  ...
  <?php } ?>
     ...
     <div class="row">
              ...
              <div class="logo">
                 ...
                 <div class="white-text  center teal z-depth-2" id="mion"><span class="flow-text"></span>MENUS</div>
                   <ul class="collapsible teal" data-collapsible="accordion">
                    <li>
                      <div class="collapsible-header z-depth-2 "><i class="tiny mdi mdi-more"></i> CATEGORY </div>
                    ...
                    <li>
                      <div class="collapsible-header z-depth-2 active"><i class="tiny mdi mdi-account-box"></i> USERS </div>
                      <div class="collapsible-body teal darken-3">
                            <ul class="left-align">
                                ...
                                <li class="divider"></li>
                                <li id="list2"> <a href=".?action=u_logs&user_id=<?= $brain_users->getUser_id();?>" class="center waves-effect waves-light btn-flat transparent white-text"><i class="left mdi mdi-gamepad-variant" id="mn_cat"></i> Admin Logs</a></li>                              
                                <li class="divider"></li>
                                <li id="list2"><a href="#!"  class="center waves-effect waves-light btn-flat transparent white-text"><i class="left glyphicon glyphicon-wrench" id="mn_cat"></i> User Update</a></li>
                            </ul>  
                      </div>
                    </li>
                  </ul>
                    ...
                    <div class="col l10" id="update_accounts">          
                          <?php include './tables/brain_tables_UpdateAccount.php'; ?>
                    </div>
      ...
      <div id="admin_profile" class="modal">
       ...
       <footer class="page-footer" id="main_u">
