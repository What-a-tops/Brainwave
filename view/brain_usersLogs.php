      ...
      <div class="col l2  z-depth-2">
              <div class="logo">
                   ...
                   <ul class="collapsible teal" data-collapsible="accordion">
                    <li>
                      ...
                      <div class="collapsible-body teal darken-3">
                             <ul class="left-align">
                                <li id="list2"><a href="?action=admin&dup=''&user_id=<?= $brain_users->getUser_id(); ?>&quest=''" class="center waves-effect waves-light btn-flat transparent white-text" ><i  class="left mdi mdi-layers" id="mn_cat"></i> Category List</a></li>
                                <li class="divider"></li>
               ...
               <div class="col l10">          
                               ...
                               <div class="white-text teal col l6 center z-depth-2" id="list_users"><span class="flow-text" id="h_list">Admin Logs</span></div>
                                 <div class="col l12">
                                     
                                                     
                                                    <div class="input-field col l3 offset-l8">
                                  ...
                                  <div class=" row ">
                                            ...
                                            <div class="col s12">
                                                   <table class="responsive-table striped centered bordered" id="logs">     
                                                            <thead>
                                                                <tr>
                                                                    <th>Image:</th>
                                                           ...
                                                           <?php include './tables/brain_table_ULogs.php';  ?>                                               
                                                  </table>
                                            </div>
