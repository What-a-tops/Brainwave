...
<body id="main_us">
 ...
 <div class="row">
                 ...
                 <div class="white-text  center teal z-depth-2" id="mion"><span class="flow-text"></span>MENUS</div>
                   <ul class="collapsible teal" data-collapsible="accordion">
                    ...
                    <li>
                      ...
                      <div class="collapsible-body teal darken-3">
                            <ul class="left-align">
                                <li id="list2"><a href="#!" class="center waves-effect waves-light btn-flat transparent white-text"><i class="left mdi mdi-account-multiple-outline" id="mn_cat"></i>  User Lists</a></li>
                                <li class="divider"></li>
                    ...
                    <div class="col l10">          
                               ...
                               <div class="white-text teal col l6 center z-depth-2" id="list_users"><span class="flow-text" id="h_list">List of Registered Users</span></div>
                                  <div class="col l12">
                                           <div class="row">
                                                                    ...
                                                                    <div class=" row ">
                                                                              ...
                                                                              <div class="col l12">
                                                                                     <table class="responsive-table striped centered bordered" id="tblData">                                
                                                                                               <?php include './tables/brain_table_userList.php';  ?>                                                  
                                                                                    </table>
                                                                              </div>
     ...
     <footer class="page-footer" id="main_us">
